...
public class Snake extends Animon {
    public Snake(Game game, String name, int health, int level, int experience, ArrayList<AttackMove> attackMoves) {
    ...
    public void draw(GameView gv) {
        ...
        bitmap = gv.getBitmapFromResource(R.drawable.a_snake);
